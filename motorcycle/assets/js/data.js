...
const RULES = {
  ...
  'riding-position': {
    ...
    quiz: [
      { q: 'در شرایط خشک، حداقل فاصله زمانی معمول با وسیله جلو چقدر است؟', qEn: 'In dry conditions, what is the normal minimum following gap?', options: [{ letter: 'A', fa: 'یک ثانیه', en: 'One second' }, { letter: 'B', fa: 'دو ثانیه', en: 'Two seconds' }, { letter: 'C', fa: 'ده ثانیه', en: 'Ten seconds' }], answer: 'B', explanation: 'در جاده خشک حداقل دو ثانیه فاصله نگه دارید. // Keep at least a two-second gap on a dry road.' },
      { q: 'در جاده خیس با فاصله دوثانیه‌ای چه باید کرد؟', qEn: 'What should you do with the two-second gap on a wet road?', options: [{ letter: 'A', fa: 'آن را نصف کنید', en: 'Halve it' }, { letter: 'B', fa: 'آن را دست‌کم دو برابر کنید', en: 'At least double it' }, { letter: 'C', fa: 'تغییری ندهید', en: 'Leave it unchanged' }], answer: 'B', explanation: 'در جاده خیس فاصله توقف بیشتر است؛ فاصله را دست‌کم دو برابر کنید. // Wet roads increase stopping distance; at least double the gap.' },
      { q: 'کجا نباید برای مدت طولانی حرکت کنید؟', qEn: 'Where should you avoid riding for long?', options: [{ letter: 'A', fa: 'در نقطه کور خودرو', en: 'In a vehicle’s blind spot' }, { letter: 'B', fa: 'جایی که راننده شما را می‌بیند', en: 'Where the driver can see you' }, { letter: 'C', fa: 'با فاصله ایمن', en: 'At a safe distance' }], answer: 'A', explanation: 'از نقطه کور خارج شوید تا دیده شوید. // Move out of blind spots so you can be seen.' },
      { q: 'هنگام عبور از پیچ به کجا نگاه کنید؟', qEn: 'Where should you look when riding through a bend?', options: [{ letter: 'A', fa: 'به مسیر خروجی', en: 'Towards the exit path' }, { letter: 'B', fa: 'فقط به چرخ جلو', en: 'Only at the front wheel' }, { letter: 'C', fa: 'به کنار جاده', en: 'At the roadside' }], answer: 'A', explanation: 'نگاهتان را به مسیر موردنظر ببرید. // Look towards your intended path.' },
    ],
  },
  ...
  junctions: {
    ...
    quiz: [
      { q: 'در تابلوی STOP چه کاری الزامی است؟', qEn: 'What is compulsory at a STOP sign?', options: [{ letter: 'A', fa: 'کاهش سرعت کافی است', en: 'Slowing is enough' }, { letter: 'B', fa: 'توقف کامل در خط', en: 'Stop completely at the line' }, { letter: 'C', fa: 'فقط بوق بزنید', en: 'Only sound the horn' }], answer: 'B', explanation: 'در تابلوی STOP باید کاملاً متوقف شوید. // You MUST stop completely at a STOP sign.' },
      { q: 'راننده‌ای در تقاطع به سمت شما نگاه می‌کند. چه فرضی درست است؟', qEn: 'A driver at a junction looks towards you. What should you assume?', options: [{ letter: 'A', fa: 'حتماً شما را دیده است', en: 'They have definitely seen you' }, { letter: 'B', fa: 'ممکن است شما را ندیده باشد', en: 'They may not have seen you' }, { letter: 'C', fa: 'حتماً به شما راه می‌دهد', en: 'They will definitely give way' }], answer: 'B', explanation: 'تماس چشمی تضمین دیده‌شدن یا سنجش درست سرعت نیست. // Eye contact does not guarantee you were seen or your speed judged correctly.' },
